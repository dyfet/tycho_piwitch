-- This may eventually become a super-set of the SipWitchQt schema as I add 
...
CREATE TABLE IF NOT EXISTS Authorize (
    ...
    pinaccess VARCHAR(8),                   -- voicemail pin
...
CREATE TABLE IF NOT EXISTS Extensions (
    ...
    pubkey VARBINARY(68) DEFAULT NULL,    -- public key to verify signed hashes
    PRIMARY KEY (extnbr),
...
CREATE TABLE IF NOT EXISTS Endpoints (
    ...
    devkey VARBINARY(68) DEFAULT NULL,      -- devices public key
    created DATETIME DEFAULT CURRENT_TIMESTAMP,
